...
void AliasUpdate(const string& node, const string& aliasname, const string& pubdata, const string& privdata, const bool safesearch=true);
...
void CertUpdate(const string& node, const string& guid, const string& title, const string& data, bool privateData=false,const bool safesearch=true);
