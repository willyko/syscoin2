    ...
    transactionView(0)
{
	...
	typeWidget->addItem(tr("Alias Activate Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::AliasActivateFee));
    typeWidget->addItem(tr("Alias Updated"), TransactionFilterProxy::TYPE(TransactionRecord::AliasUpdate));
	typeWidget->addItem(tr("Alias Update Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::AliasUpdateFee));
    typeWidget->addItem(tr("Alias Transferred"), TransactionFilterProxy::TYPE(TransactionRecord::AliasTransfer));
	typeWidget->addItem(tr("Alias Transfer Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::AliasTransferFee));
	...
	typeWidget->addItem(tr("Offer Activate Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::OfferActivateFee));
    typeWidget->addItem(tr("Offer Updated"), TransactionFilterProxy::TYPE(TransactionRecord::OfferUpdate));
	typeWidget->addItem(tr("Offer Update Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::OfferUpdateFee));
	...
	typeWidget->addItem(tr("Offer Refund In Progress Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::OfferAcceptRefundInProgressFee));
	typeWidget->addItem(tr("Offer Refund Complete"), TransactionFilterProxy::TYPE(TransactionRecord::OfferAcceptRefundComplete));
	typeWidget->addItem(tr("Offer Refund Complete Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::OfferAcceptRefundCompleteFee));
  
    typeWidget->addItem(tr("Certificate Activated"), TransactionFilterProxy::TYPE(TransactionRecord::CertActivate));
	typeWidget->addItem(tr("Certificate Activate Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::CertActivateFee));
    typeWidget->addItem(tr("Certificate Updated"), TransactionFilterProxy::TYPE(TransactionRecord::CertUpdate));
	typeWidget->addItem(tr("Certificate Update Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::CertUpdateFee));
    typeWidget->addItem(tr("Certificate Transferred"), TransactionFilterProxy::TYPE(TransactionRecord::CertTransfer));
	typeWidget->addItem(tr("Certificate Transfer Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::CertTransferFee));
	...
	typeWidget->addItem(tr("Escrow Activate Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::EscrowActivateFee));
    typeWidget->addItem(tr("Escrow Released"), TransactionFilterProxy::TYPE(TransactionRecord::EscrowRelease));
	typeWidget->addItem(tr("Escrow Release Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::EscrowReleaseFee));
    typeWidget->addItem(tr("Escrow Refunded"), TransactionFilterProxy::TYPE(TransactionRecord::EscrowRefund));
	typeWidget->addItem(tr("Escrow Refund Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::EscrowRefundFee));
	...
	typeWidget->addItem(tr("Escrow Complete Data Fee"), TransactionFilterProxy::TYPE(TransactionRecord::EscrowCompleteFee));
...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    if(SyscoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(SyscoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
