...
std::string CheckForAliasExpiry(const std::vector<unsigned char> &vchPubKey, const int nHeight,  const std::vector<std::vector<unsigned char> > vvchAlias=vchFromString(""));
